...
const copy = {
  ...
  ja: {
    ...
    groupExtendedAe: 'ExtendedAE',
    groupCreate: 'Create / Create Crafts & Additions',
    useStructuralGlass: '構造用ガラスを使用',
    useReactorGlass: 'リアクターガラスを使用',
    ...
    fusionCoolingAir: '空冷',
    quantumStorageTier: '量子ストレージ種別',
    quantumUseDataEntangler: '量子データエンタングラーを使用',
    quantumUseMultiThreader: '量子マルチスレッダーを使用',
    quantumStorage128: '128M',
    quantumStorage256: '256M',
    toggleOn: 'ON',
    toggleOff: 'OFF',
    ...
    matrixCells: 'インダクションセル数',
    matrixProviders: 'インダクションプロバイダー数',
    spsCoils: '過充電コイル数',
    boilerSteamHeight: 'ボイラー蒸気層の高さ (内側層)',
    boilerSuperheatingElements: '過熱素子数',
    turbineRotorHeight: 'ローター高さ (ブロック)',
    turbineBladesPerRotor: 'ローターあたりブレード数',
    turbineCoils: '電磁コイル数',
    turbineCondensers: '飽和凝縮器数',
    turbineUseTopVents: '天面をタービンベントにする',
    turbineVentSideLayers: '側面タービンベント層数',
    fissionAssemblies: '燃料アセンブリ数',
    fissionAssemblyHeight: '燃料アセンブリ高さ',
    fissionBurnRate: '燃焼レート',
    fissionLogicAdapters: 'ロジックアダプター数',
    fusionLogicAdapters: 'ロジックアダプター数',
    fusionInjectionRate: '注入レート',
    quantumDataEntanglers: '量子データエンタングラー数',
    quantumMultiThreaders: '量子マルチスレッダー数',
    quantumAccelerators: '量子アクセラレーター数',
    quantumStorageBlocks: '量子ストレージブロック数',
    matrixPatternCores: 'アセンブラーマトリックス・パターンコア数',
    matrixCraftCores: 'アセンブラーマトリックス・クラフトコア数',
    matrixSpeedCores: 'アセンブラーマトリックス・スピードコア数',
    createBlazeBurners: 'ブレイズバーナー数',
    ...
    resources: {
      ...
      quantumCore: '量子コンピューターコア',
      quantumDataEntangler: '量子データエンタングラー',
      quantumMultiThreader: '量子マルチスレッダー',
      quantumAccelerator: '量子アクセラレーター',
      quantumComputerStructuralGlass: '量子コンピューター構造用ガラス',
      quantumCraftingUnit: '量子クラフトユニット',
      quantumStorage128: '128M 量子コンピューターストレージ',
      quantumStorage256: '256M 量子コンピューターストレージ',
      assemblerMatrixFrame: 'アセンブラーマトリックスフレーム',
      assemblerMatrixWall: 'アセンブラーマトリックス壁/ガラス',
      assemblerMatrixPatternCore: 'アセンブラーマトリックス・パターンコア',
      assemblerMatrixCraftCore: 'アセンブラーマトリックス・クラフトコア',
      assemblerMatrixSpeedCore: 'アセンブラーマトリックス・スピードコア',
      createFluidTank: '流体タンク',
      createBlazeBurner: 'ブレイズバーナー',
      createSteamEngine: 'スチームエンジン',
      createStraw: '藁',
    } as Record<ResourceKey, string>,
              ...
              .map((line) => (
                <div key={line.key}>
                  ...
                  <dd>
                    ...
                    {line.key === 'createBoilerLevel' && line.value === CREATE_BOILER_MAX_LEVEL ? ' (Max)' : ''}
                  </dd>
                </div>
              ))}
          </dl>
